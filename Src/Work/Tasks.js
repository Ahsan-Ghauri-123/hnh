...
const Tasks = (props) => {
    ...
    const dateRanges = [
        { key: '1', value: 'Hide Completed Task' },
        { key: '2', value: 'All' },
        { key: '4', value: 'Incomplete' },
        { key: '5', value: 'completed' },
        { key: '6', value: 'Client is checking' },
        { key: '7', value: 'Client not say not done' },
    ];
    const date = [
        { key: '1', value: 'Today' },
    ...
    return (
        <ScrollView style={{ flex: 1, backgroundColor: "white" }}>
            ...
            <View style={{ marginHorizontal: wp(8), flexDirection: "row", marginTop: hp(3) }}>
                <Text style={{ fontSize: hp(3), fontWeight: 'bold', color: 'black' }}>TimeLogs</Text>
                <TouchableOpacity
                    onPress={() => {
                ...
                <Text style={{ fontSize: hp(2), color: 'gray', fontWeight: 'bold', marginHorizontal: wp(1), marginTop: hp(1) }}>• TimeLogs</Text>
            </View>
            <View style={{ flexDirection: "row", justifyContent: "space-between", marginTop: hp(3) }}>
                ...
                <View style={{ flexDirection: "row" }}>
                    ...
                    <TouchableOpacity
                        ...
                        <Ico name="view-column" size={hp(3.4)} color="black" />
                    </TouchableOpacity>
                    <TouchableOpacity
                        onPress={() => {
                            props.navigation.navigate("LeadKanboard");
                    ...
                    <TouchableOpacity
                        ...
                        <Icons name="pushpino" size={hp(3.4)} color="black" />
                    </TouchableOpacity>
                </View>
            </View>
