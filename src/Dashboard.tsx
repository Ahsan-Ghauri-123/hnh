    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: 'white', marginTop: 5 }}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end', width: '100%' }}>
        <View style={{ flexDirection: 'row', padding: 12 }}>
          ...
          <Text style={{fontSize:14, marginHorizontal:1}}>Dashboard</Text>
          </TouchableOpacity>
          <TouchableOpacity>
          <Text style={{fontSize:14, marginHorizontal:28}}>Home •</Text>
          </TouchableOpacity>
          <Image source={require('./../Assets/search.png')} style={{ marginHorizontal: 2 }} />
          <Image source={require('./../Assets/note.png')} style={{ marginHorizontal: 2 }} />
          <Image source={require('./../Assets/time.png')} style={{ marginHorizontal: 2 }} />
          <Image source={require('./../Assets/plus.png')} style={{ marginHorizontal: 2 }} />
          <Image source={require('./../Assets/notification.png')} style={{ marginHorizontal: 2 }} />
          <Image source={require('./../Assets/power.png')} style={{ marginHorizontal: 2 }} />
        </View>
      </View>
      <ScrollView>
        <View
